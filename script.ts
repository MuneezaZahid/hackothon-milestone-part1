  ...
  const workExperienceData: WorkExperience[] = [
    {
      ...
      years: "2022 - 2024",
      description:
        "The IT Manager is responsible for overseeing the planning, implementation, and management of an organization's information technology systems and infrastructure.",
    },
  ];
